...
{
    public class FakeCodeTalkContext:  CodeTalkContext , ITalkRepository, ICommentRepository
    {
        public DbSet<Talk> Talks { get; set; }
        public DbSet<Comment> Comments { get; set; }

        public List<Talk> aTalks { get; set; }
        public List<Comment> aComments { get; set; }

        public FakeCodeTalkContext()
        {
            // Initialize lists 

            // Talks
            aTalks = new List<Talk>();
        ...
        {
            return aTalks.AsQueryable<Talk>();
        }
